...
def them(band_name, years_active):
    conn = sqlite3.connect('artist.db')
    c = conn.cursor()
    # Them vao co so du lieu
    c.execute('''
        INSERT INTO artist(band_name, years_active)
        VALUES (:band_name, :years_active)
    ''',
      {
          'band_name': band_name,
...
for link1 in artist_links:
    ...
    try:
        years_active = driver.find_element(By.XPATH, "//th[span[text()='Years active']]/following-sibling::td").text
    except:
        years_active = ""
